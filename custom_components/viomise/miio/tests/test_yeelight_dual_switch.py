...
from custom_components.viomise.miio import YeelightDualControlModule
from custom_components.viomise.miio.yeelight_dual_switch import Switch, YeelightDualControlModuleException
