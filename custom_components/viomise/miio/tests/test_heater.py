...
from custom_components.viomise.miio import Heater
from custom_components.viomise.miio.heater import MODEL_HEATER_ZA1, Brightness, HeaterException, HeaterStatus
