...
from custom_components.viomise.miio import WifiRepeater
from custom_components.viomise.miio.tests.dummies import DummyDevice
from custom_components.viomise.miio.wifirepeater import WifiRepeaterConfiguration, WifiRepeaterStatus
...
class DummyWifiRepeater(DummyDevice, WifiRepeater):
    ...
    def info(self):
        ...
        from custom_components.viomise.miio.deviceinfo import DeviceInfo
