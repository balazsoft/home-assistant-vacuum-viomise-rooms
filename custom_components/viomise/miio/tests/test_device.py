...
from custom_components.viomise.miio import Device, MiotDevice, Vacuum
from custom_components.viomise.miio.exceptions import DeviceInfoUnavailableException, PayloadDecodeException
