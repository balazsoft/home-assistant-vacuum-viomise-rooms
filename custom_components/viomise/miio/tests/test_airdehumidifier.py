...
from custom_components.viomise.miio import AirDehumidifier
from custom_components.viomise.miio.airdehumidifier import (
...
from custom_components.viomise.miio.device import DeviceInfo
