...
from custom_components.viomise.miio import PhilipsEyecare
from custom_components.viomise.miio.philips_eyecare import PhilipsEyecareException, PhilipsEyecareStatus
